...
function injectStyles() {
    ...
    style.textContent = `
        ...
        .cerb-anim-block-pulse { animation: cerbBlockPulse 2s ease-in-out 2 forwards !important; }
        ...
        /* UI Neutra para Pausar Chat */
        .cerb-mute-chat-fab { bottom: 100px; border: 1px solid rgba(255, 255, 255, 0.1); color: #ccc; }
